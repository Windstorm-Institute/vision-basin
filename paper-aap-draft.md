...
The full experimental methodology, results tables with 95 percent confidence intervals, the v2.1 from-scratch verification round, and the v2.2 methodological-journey + adversarial-review-defense framework are detailed in the accompanying paper.pdf (current version v2.2) and in the Grand Slam Supplementary Materials PDF in this repository.
