...
The full methods, results tables with 95 percent confidence intervals, cross-modal comparisons, the v2.1 from-scratch verification round, and the v2.2 methodological-journey + adversarial-review-defense framework are in the accompanying paper.pdf (current version v2.2) in this repository.
